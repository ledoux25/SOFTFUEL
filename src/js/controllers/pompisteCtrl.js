...
app.controller('pompisteCtrl', ['$scope', '$filter', '$http', '$modal', '$log', 'editableOptions', 'editableThemes',
  function($scope, $filter, $http, $modal, $log, editableOptions, editableThemes){
    ...
    $scope.sexes = [{id:1 , nom:'MASCULIN'}, {id:2 , nom:'FEMININ'}] ;

    $scope.today = function() {
      $scope.pom.date_naissance = new Date();
      $scope.pom.date_embauche = new Date();
    };
    $scope.today();
...
/***************************************************************************************************************/      
    ...
    $scope.add_pompiste = function(){

      $http.post('api/pompistes.php?action=add_pompiste',
