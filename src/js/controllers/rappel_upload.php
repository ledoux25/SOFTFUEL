<?php
     ...
     function sendEmail($email_station, $email_regional, $nom_station, $date_quart, $html){
       ...
       /*  $mail->addAddress($email_direction);     // Add a recipient
         $mail->addAddress($email_superviseur);               // Name is optional
         $mail->addAddress($email_superviseur2);               // Name is optional
         $mail->addAddress($email_superviseur3);               // Name is optional
         $mail->addAddress($email_superviseur4);               // Name is optional
         $mail->addAddress($email_superviseur5);               // Name is optional
        
         $mail->addAddress($email_superviseur6);               // Name is optional
         $mail->addAddress($email_superviseur7);               // Name is optional
         $mail->addAddress($email_superviseur8);               // Name is optional
         $mail->addAddress($email_superviseur9);               // Name is optional
         $mail->addAddress($email_superviseur10); 
          
         $mail->addAddress($email_superviseur11);               // Name is optional
         $mail->addAddress($email_superviseur12);
         $mail->addAddress($email_superviseur13);
         $mail->addAddress($email_superviseur14); 

         */

         $mail->addAddress($email_regional);
        // $mail->addAddress('eric.monkam@blessingpetroleum.net');
