app.controller('ModalInstanceBeatCtrl', ['$scope', '$modalInstance', 'items', function($scope, $modalInstance, items) {
  ...
  app.controller('etatGazCtrl', ['$scope', '$filter', '$http','$localStorage',
  ...
  */
  ...
  $http.post('api/pompistes.php?action=Etats_Ventes_Gaz',
  ...
  $scope.stock = function(){
   ...
   $http.post('api/pompistes.php?action=Etats_Stock_Gaz',
