 ...
 */
 ...
 /*    $sheet->setCellValueByColumnAndRow(1, 1, 'STATION') ;
    ...
    $sheet->setCellValueByColumnAndRow(1, 1, 'STATION') ;
    $sheet->setCellValueByColumnAndRow(2, 1, 'SUPER(L)') ;
    $sheet->setCellValueByColumnAndRow(3, 1, 'GASOIL(L)') ;
    $sheet->setCellValueByColumnAndRow(4, 1, 'PETROLE(L)') ;
    $sheet->setCellValueByColumnAndRow(5, 1, 'TOTAL(L)') ;
    $sheet->setCellValueByColumnAndRow(6, 1, 'SUPER(M)') ;
    $sheet->setCellValueByColumnAndRow(7, 1, 'GASOIL(M)') ;
    $sheet->setCellValueByColumnAndRow(8, 1, 'PETROLE(M)') ;
    $sheet->setCellValueByColumnAndRow(9, 1, 'TOTAL(M)') ;
 ...
 */
    ...
    foreach ($requete as $key => $value) {
     ...
     /*  $sheet->setCellValueByColumnAndRow(1, $key_ligne, $value->station) ;
      ...
      $sheet->setCellValueByColumnAndRow(1, $key_ligne, $value->station) ;
      $sheet->setCellValueByColumnAndRow(2, $key_ligne, $value->cou_super_l) ;
      $sheet->setCellValueByColumnAndRow(3, $key_ligne, $value->cou_gasoil_l) ;
      $sheet->setCellValueByColumnAndRow(4, $key_ligne, $value->cou_petrole_l) ;
      $sheet->setCellValueByColumnAndRow(5, $key_ligne, $value->cou_total_l) ;
      $sheet->setCellValueByColumnAndRow(6, $key_ligne, $value->cou_super_m) ;
      $sheet->setCellValueByColumnAndRow(7, $key_ligne, $value->cou_gasoil_m) ;
      $sheet->setCellValueByColumnAndRow(8, $key_ligne, $value->cou_petrole_m) ;
      $sheet->setCellValueByColumnAndRow(9, $key_ligne, $value->cou_total_m) ;
